...
import { formatCapabilitiesForPrompt, CAPABILITIES } from "../_lib/capabilities.js";
...
export async function onRequestPost({ request, env }) {
  ...
  // Basic safety: cap conversation length so a misbehaving client can't blow up the bill
  ...
  // Re-encode Anthropic's SSE stream into plain text deltas for easy client parsing.
